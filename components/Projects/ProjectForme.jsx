...
function ProjectForme({ handleSubmit,projectData, btnText }) {
    ...
    // Estado para armazenar as categorias e graus carregadas da API
    ...
    useEffect(() => {
        ...
        if (projectData) {
            ...
            setGrauId(String(projectData.grauId || "")); // Conversão para string por segurança    // Grau escolar
 ...
 // Dependências do useEffect:
    ...
    return (
        <form className={styles.form} onSubmit={submitForm}>
            ...
            <Select 
            name="category_id" 
            text="Selecione o tipos de estado da questão" //É o tipo de estado q a questão (revisão, aprovada)
            options={categoris}
            value={categoryId}
            handleOnChange={(e) => {
