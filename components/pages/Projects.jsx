...
function Project() {
    ...
    const [grauName, setGrauName ] = useState(''); // ID do grau escolar selecionado
 ...
 // Dependência: reexecuta sempre que tipoQuestao mudar
  ...
  return normalizar(p.serieAno) === normalizar(serieAno);
})
